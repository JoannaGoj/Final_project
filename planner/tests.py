...
@pytest.mark.django_db
def test_manage_tasks_post(client, user):
    url = reverse('manage_tasks')
...
@pytest.mark.django_db
def test_manage_events_post(client, user):
    url = reverse('manageevents')
    today = datetime.now()
    data = {
        'user': user.id,
...
@pytest.mark.django_db
def test_manage_tags_post(client, user):
    url = reverse('manage_tags')
    data = {
        'name': 'testowyfiolet',
    }
...
@pytest.mark.django_db
def test_show_journal_post(client, user):
    url = reverse('show_all_journal_entries')
    today = datetime.now()
    data = {
        'user': user.id,
